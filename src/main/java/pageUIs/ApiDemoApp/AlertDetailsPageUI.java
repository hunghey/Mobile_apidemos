...
public class AlertDetailsPageUI {
    //AlertDialogUI
    public static final String NORMAL_ALERT = "ACCESSIBILITYID=OK Cancel dialog with a message";
    ...
    public static final String OK_BTN = "XPATH=//android.widget.Button[@text='OK']";
    public static final String CANCEL_BTN = "XPATH=//android.widget.Button[@text='Cancel']";
